            ...
            {isMobileSidebarOpen &&
                <>
                    <motion.div
                        ...
                        className="bg-black md:hidden flex opacity-30 fixed top-0 z-[99] left-0 right-0 bottom-0 w-full"
                    ></motion.div>
                    <motion.div
                        ...
                        className="min-h-screen md:hidden fixed top-0 z-[100000] left-0 flex-row bg-gray-100"
                    >
                        <div className='md:hidden block basis-1/4 h-full z-50 bg-white'>
